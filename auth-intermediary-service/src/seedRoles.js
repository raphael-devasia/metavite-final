...
var roles_model_1 = require("../src/models/roles.model");
var seedRoles = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 5, , 6]);
                return [4 /*yield*/, mongoose_1.default.connect("mongodb://localhost:27017/Metavite_Verify")];
            case 2:
                _a.sent();
                console.log("Connected to the database");
                // Remove existing roles to avoid duplicates
                return [4 /*yield*/, roles_model_1.RoleModel.deleteMany({})];
            case 3:
                // Remove existing roles to avoid duplicates
                _a.sent();
                console.log("Existing roles cleared");
                // Insert new roles
                return [4 /*yield*/, roles_model_1.RoleModel.insertMany(roles)];
            case 4:
                // Insert new roles
                _a.sent();
