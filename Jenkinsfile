pipeline {
    ...
    stages {
        ...
        stage('Build and Push Docker Images') {
            steps {
                script {
                    def services = ['api-gateway', 'auth-service', 'carrier-service', 'load-service', 'notification-service', 'security-service', 'shipper-service','payments-service','chat-service']
